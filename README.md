...
Este proyecto analiza datos de Recursos Humanos con el objetivo de identificar patrones en el comportamiento de los colaboradores, su nivel de satisfacción y la estructura organizacional.

## 🎯 Objetivo

Generar insights que ayuden a la toma de decisiones en la gestión del talento, enfocándose en la satisfacción del personal, el ausentismo y la distribución de la fuerza laboral.
